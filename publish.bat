...
scp ./IoTDisplay.ConsoleApp/bin/Release/net5.0/linux-arm/publish/* pi@iotdisplay:/home/pi/epaper
scp ./IoTDisplay.WebApp/bin/Release/net5.0/linux-arm/publish/* pi@iotdisplay:/home/pi/epaper
scp ./appsettings.json pi@iotdisplay:/home/pi/epaper/
del appsettings.json
ssh pi@iotdisplay sudo chmod 755 /home/pi/epaper/IoTDisplay.ConsoleApp /home/pi/epaper/IoTDisplay.WebApp
